...
def drop_tablespace() -> core.Checker:
...
def lint_drop_tablespace(
    linter: core.Linter, drop_tablespace: core.Checker,
) -> core.Linter:
    """Lint DropTablespace."""
...
def test_drop_tablespace_rule_code(drop_tablespace: core.Checker) -> None:
    """Test drop tablespace rule code."""
    assert drop_tablespace.code == drop_tablespace.__module__.split(".")[-1]


def test_drop_tablespace_auto_fixable(drop_tablespace: core.Checker) -> None:

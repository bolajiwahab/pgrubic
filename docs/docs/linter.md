...
will enable all the rules with the prefix `TP`, which falls under the [**typing**](rules/#typing-tp) category, with the exception of [**TP015**](rules/typing/wrongly-typed-required-column.md).
...
will enable fixes for all the rules with the prefix `TP`, which falls under the [**typing**](rules/#typing-tp) category, with the exception of [**TP015**](rules/typing/wrongly-typed-required-column.md). Please note that **unfixable** takes precedence over **fixable**.

...
```console
docker run --rm -it -v $PWD:/sql ghcr.io/bolajiwahab/pgrubic:3.1.0 lint *.sql     # Lint SQL files
docker run --rm -it -v $PWD:/sql ghcr.io/bolajiwahab/pgrubic:3.1.0 format *.sql   # Format SQL files
```

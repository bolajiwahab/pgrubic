...
- To skip formatting a file, you can use either use `-- pgrubic: fmt: skip` directive at the top of the file or add the file name to the [**format.exclude**](settings/#exclude_2) setting

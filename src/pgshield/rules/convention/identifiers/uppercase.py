...
class UpperCaseInIdentifier(linter.Checker):  # type: ignore[misc]
    ...
    def _check_identifier(self, *args: typing.Any, **kwargs: typing.Any) -> None:
        ...
        functions: list[typing.Callable] = [
            self._check_identifier_for_uppercase_for_uppercase,
    ...
    def _check_identifier_for_uppercase_for_uppercase(
        self,
        identifier: str,
        location: int,
        statement: str,

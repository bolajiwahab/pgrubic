...
def is_non_volatile_function(
    *,
    ...
    """Check if function is non volatile against PostgreSQL built-in functions
    ...
    function_fully_qualified_name = get_fully_qualified_name(function_name)

    return (
        function_fully_qualified_name in BUILTIN_NON_VOLATILE_FUNCTIONS
        or function_fully_qualified_name in additional_non_volatile_functions
    )
